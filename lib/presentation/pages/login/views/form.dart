...
import 'package:himu_shop/presentation/pages/login/views/social_button.dart';
import 'package:himu_shop/presentation/routes/app_routes.dart';
import 'package:himu_shop/presentation/widgets/default_btn.dart';
import 'package:himu_shop/presentation/widgets/default_logo.dart';
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (controller.isSignIn.value)
                      InkWell(
                        onTap: () {
                          navigator!.pushNamed(HimuShopRoutes.checkAccount);
                        },
                        child: Text(
                          'Forget Password ?',
