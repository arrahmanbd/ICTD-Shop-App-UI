...
import 'package:himu_shop/package/product_rating.dart';
...
import 'package:himu_shop/presentation/pages/details/view/add_cart.dart';
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              actions: [
                InkWell(onTap: () {
                  Navigator.of(context).pushNamed(HimuShopRoutes.cart);
                }, child: Obx(() {
                  return Stack(
                    children: [
                      Container(
